...
train_esm1b_P = pd.read_csv('HLA_alt_tr_pos_PseAAC.csv')

train_esm1b_N = pd.read_csv('HLA_alt_tr_neg_PseAAC.csv')
...
# Save model
import joblib
joblib.dump(model, 'XGBRFmodel.pkl')
